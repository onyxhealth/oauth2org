...
"""
mailer module
Based on mailer module updated for Python 3 only.
...
__version__ = "0.9.0"
__author__ = "Mark Scrimshire/Ryan Ginstrom"
__license__ = "MIT"
...
class Manager(threading.Thread):
    ...
    If a message was successfully sent, self.results[msg.message_id] returns a 3
