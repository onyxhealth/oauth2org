...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='application',
            name='op_tos_uri',
            field=models.CharField(blank=True, default='https://example.com/terms-of-service-1.0.html', max_length=512),
        ),
        migrations.AlterField(
            model_name='application',
            name='redirect_uris',
        ...
        migrations.AlterField(
            ...
            name='applications',
            field=models.ManyToManyField(blank=True, null=True, to=settings.OAUTH2_PROVIDER_APPLICATION_MODEL),
        ),
    ]
